...
--}}
<hr/>
<p>Question {{ $question->id }}, type 2:</p>
...
<div class="form-group row">
    ...
    <div class="col-sm-10" id="q_{{ $question->id }}_answers">
        <table class="table table-hover table-sm m-0">
            ...
            @foreach ($question->getAnswers() as $answer)
                <tr id="tra{{ $answer->id }}">
                    ...
                    <td class="align-middle text-center">
                        <input name="question[{{ $question->id }}][iscool]" type="checkbox" class="btooltip" value="{{ $answer->id }}" data-toggle="tooltip" title="Correct Answer" {{ $answer->is_correct ? "checked" : "" }} />
                    </td>
                    <td class="align-middle text-center">
