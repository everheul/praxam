            ...
            <div class="card w-100">
                ...
                <div class="card-body p-2">
                    <div class="table-responsive">
                        <table class="table table-borderless table-hover table-sm mb-1">
                            ...
                            <tbody>
                              @foreach($scenes as $scene)
                                <tr>
                                    ...
                                    <td><div class="tbltxt">{{ $scene->id }}</div></td>
                                    <td><div class="tbltxt">{{ $scene->head }}</div></td>
                                    <td><div class="tbltxt">{{ $scene->question_count }}</div></td>
